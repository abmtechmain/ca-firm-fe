...
export default function ContactBar() {
  return (
    // Contact information commented out as requested
    ...
    //         </svg>
    //         <span className="text-black text-xs sm:text-sm md:text-base break-all sm:break-normal">{CONTACT_INFO.email}</span>
    //       </div>
    //       <div className="flex items-center gap-2">
    //         <svg className="w-4 h-4 text-black flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    //           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
    //         </svg>
    //         <span className="text-black text-xs sm:text-sm md:text-base">{CONTACT_INFO.landline}</span>
    //       </div>
    ...
    //         </svg>
    //         <span className="text-black text-xs sm:text-sm md:text-base">{CONTACT_INFO.offices[0].address}</span>
    //       </div>
    //     </div>
    //   </div>
    // </div>
